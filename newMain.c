...
/*
	Nom Fonction : on_bouton_clicked
	Entree :un widget et un pointeur de type Dialog
	Sortie:
	Description :affiche une boite de dialog
*/
...
/*
	Nom Fonction : dialogue_action
	Entree :un widget et un pointeur de type Dialog
	Sortie:
	Description :quand le widget associé est cliqué on fait appel à la fonction
                on_bouton_clicked
*/
...
int main(int argc, char* argv[])
{
    ...
    Fenetre* wind;
    //remplir la structure de type Fenetre
    ...
    //-------------------------------------  Fixed       -------------------------------------------------
    fixed = Allouer_fixed("fixed");

    //-------------------------------------    Simple boutton     --------------------------------------------------
    //création des simples bouttons et les'ajouter au fixed
...
//initialisation et création de la frame
...
//création des bouttons à ajouter dans la frame
...
//création d'un label
    ...
    /*-------------------------------------nouvelle fenetre---------------------------*/
    //création d'une nouvelle fenetre qui s'affiche quand on click sur un boutton
    //déclaration des variables
    GtkWidget* label;
    Fenetre* nouvfen;
    Label* label1;
    ...
    Fixed* fixed1 = Allouer_fixed("fixed1");
